...
//	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.aws-ssm-load-helper.yaml)")
...
func initConfig() {
	...
	//	}
	//
	//	// Search config in home directory with name ".aws-ssm-load-helper" (without extension).
	//	viper.AddConfigPath(home)
	//	viper.SetConfigName(".aws-ps")
	//}
	//
